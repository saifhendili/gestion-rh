...
import { AddAutreAppelations,AddEtatDeFiche,AddRattachements,AddCompetencesManagerials,AddCompetencesComportementales,addFiche,AddClientsDuPoste, getFiche,AddFournisseursDuPoste ,AddAutreResponsabilite,AddCaracteristiqueDuPoste,AddIndicateursDePerformance,AddDimensionnementDuPoste,AddCompetencesTransverses,AddCompetencesMetier, getCategorie, getCompetance, getSousCategorie} from '../../actions/fiche'
...
function AddFichePost({getSousCategorie,AddAutreAppelations,AddEtatDeFiche,AddRattachements,AddCompetencesManagerials,AddCompetencesComportementales,addFiche,AddClientsDuPoste,AddCaracteristiqueDuPoste,getCategorie,getCompetance,AddAutreResponsabilite,getFiche,AddIndicateursDePerformance,AddDimensionnementDuPoste,AddCompetencesTransverses,AddFournisseursDuPoste,AddCompetencesMetier,fiche:{Rattachment,MyCategorie,Competances,id,fiche,loading,ClientsDuPoste,FournisseursDuPoste,AutreResponsabilite,MyCompetencesTransverses,DimensionnementDuPoste,MyIndicateursDePerformance,myAutreAppelations,myEtatDeFiche,Souscategorie}}) {
    ...
    const [titre, settitre] = useState('administrateur de base des données');
  ...
  const submitcarac=(e)=>{
    e.preventDefault();
    AddCaracteristiqueDuPoste(id,{ RattachementsHierarchique,RattachementsFonctionnel,Execution,Expertise,Operationnel,decisions ,Production});  
...
useEffect(()=>{
  ...
  getCompetance()
   ...
   return loading || MyCategorie === null||Competances===null ? (
    <Spinner />
  ) : (
    <Fragment>
...
<div class="row">
  ...
  <form className='fixecard'   onSubmit={(e) => {
          e.preventDefault();
          addFiche({titulaire,profil,exigence,RattachementsHierarchique,RattachementsFonctionnel,Categorie,titre,Description,SousCategorie });  
          setisOpen(true) 
...
<input type="text" class="form-control" name="profil" onChange={(e) => setprofil(e.target.value)} id="formGroupExampleInput" placeholder="Profile"/>
</div>
<div class="form-group ">
<label for="formGroupExampleInput">Exigence</label>
<input type="text" class="form-control" name="exigence" onChange={(e) => setexigence(e.target.value)} id="formGroupExampleInput" placeholder="exigence"/>
</div>
<div class="col-12">
    <div class="card mb-4">
      <div class="card-header pb-0 fixtable">
        ...
        <div class="table-responsive p-0">
          <table class="table align-items-center mb-0 mt-0">
            ...
            <tbody>
                 ...
                 <input type="text" class="form-control" name="RattachementsHierarchique" onChange={(e) => setRattachementsHierarchique(e.target.value)} id="formGroupExampleInput" placeholder="Example input"/>

                 </td>
                 <td class="align-middle ">
                 <input type="text" class="form-control" name="RattachementsFonctionnel" onChange={(e) => setRattachementsFonctionnel(e.target.value)} id="formGroupExampleInput2" placeholder="Another input"/>
                 </td>
                 {/* <td class="align-middle">
        ...
        <div class="table-responsive p-0">
          <table class="table align-items-center mb-0 mt-0">
            ...
            <tbody>
              ...
              <td>
Execution</td>
{Execution!=1? <td onClick={()=>setExecution(1)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExecution(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
              {Execution!=2? <td onClick={()=>setExecution(2)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExecution(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
              {Execution!=3? <td onClick={()=>setExecution(3)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExecution(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
       {Execution!=4? <td onClick={()=>setExecution(4)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExecution(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
       {Execution!=5? <td onClick={()=>setExecution(5)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExecution(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
       {Execution!=6? <td onClick={()=>setExecution(6)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExecution(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
              ...
              <td>
              Expertise</td>
{Expertise!=1? <td onClick={()=>setExpertise(1)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExpertise(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
              {Expertise!=2? <td onClick={()=>setExpertise(2)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExpertise(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
              {Expertise!=3? <td onClick={()=>setExpertise(3)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExpertise(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
       {Expertise!=4? <td onClick={()=>setExpertise(4)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExpertise(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
       {Expertise!=5? <td onClick={()=>setExpertise(5)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExpertise(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
       {Expertise!=6? <td onClick={()=>setExpertise(6)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setExpertise(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
              ...
              <td>
              Opérationnel</td>
{Operationnel!=1? <td onClick={()=>setOperationnel(1)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setOperationnel(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {Operationnel!=2? <td onClick={()=>setOperationnel(2)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setOperationnel(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {Operationnel!=3? <td onClick={()=>setOperationnel(3)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setOperationnel(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {Operationnel!=4? <td onClick={()=>setOperationnel(4)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setOperationnel(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {Operationnel!=5? <td onClick={()=>setOperationnel(5)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setOperationnel(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {Operationnel!=6? <td onClick={()=>setOperationnel(6)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setOperationnel(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
              ...
              <td>
              Pas de décisions</td>
      {decisions!=1? <td onClick={()=>setdecisions(1)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setdecisions(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {decisions!=2? <td onClick={()=>setdecisions(2)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setdecisions(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {decisions!=3? <td onClick={()=>setdecisions(3)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setdecisions(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {decisions!=4? <td onClick={()=>setdecisions(4)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setdecisions(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {decisions!=5? <td onClick={()=>setdecisions(5)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setdecisions(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
      {decisions!=6? <td onClick={()=>setdecisions(6)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setdecisions(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
              ...
              <td>
              Production</td>
        {Production!=1? <td onClick={()=>setProduction(1)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setProduction(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
        {Production!=2? <td onClick={()=>setProduction(2)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setProduction(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
        {Production!=3? <td onClick={()=>setProduction(3)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setProduction(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
        {Production!=4? <td onClick={()=>setProduction(4)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setProduction(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
        {Production!=5? <td onClick={()=>setProduction(5)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setProduction(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
        {Production!=6? <td onClick={()=>setProduction(6)} className='fixonclicktable' scope="row"></td>:     <td onClick={()=>setProduction(1)} className='fixonclicktable colorTableChmp' scope="row"></td>}  
...
export default  connect(mapStateToProps, {getSousCategorie,AddAutreAppelations,AddEtatDeFiche,AddRattachements, addFiche,AddClientsDuPoste,AddCaracteristiqueDuPoste,AddCompetencesManagerials,AddCompetencesComportementales,getCategorie,getCompetance,getFiche,AddFournisseursDuPoste,AddAutreResponsabilite,AddIndicateursDePerformance,AddDimensionnementDuPoste,AddCompetencesTransverses,AddCompetencesMetier }) (AddFichePost)